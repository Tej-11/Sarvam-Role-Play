...
export const AudioProvider : React.FC<{children: ReactNode}> = ({children}) => {
    ...
    const setRecordingData = (url: string | null, blob: globalThis.Blob | null) => {
        setAudioURL(url);
        setAudioBlob(blob);
    };
    ...
    return (
        <RecorderContext.Provider value={{ audioURL, audioBlob, status, setRecordingData, updateStatus }}>
            {children}
